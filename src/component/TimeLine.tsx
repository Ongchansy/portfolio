...
const TimeLine = () => {
  ...
  return (
    <div className="mxl:container xl:mx-auto px-4 py-8 md:py-12">
      <h1 className="text-2xl md:text-[3.2rem] font-bold text-title text-center mb-8 md:mb-12">Company Timeline</h1>
