...
const Education = () => {
  return (
    <div className='px-8' id='education'>
        ...
        <div className='bg-primary-background px-[5rem] lg:px-[10rem] py-[4.7rem] '>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2'>
                <div>
                    <h5 className='md:mb-[2.5rem] mb-[1rem] font-medium text-[1.8rem] text-title'>Front-End Development Training</h5>
                    <div className='flex gap-5 items-center mb-[1rem]'>
                        <p className='text-[1.5rem]'>Student</p>
                ...
                <div>
                    <p className='md:mb-[2.5rem] mb-[1rem] font-medium text-2xl md:text-[1.8rem] md:text-title'>Certificate of web front-end training</p>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2'>
                <div className=''>
                    <h5 className='md:mb-[2.5rem] mb-[1rem] font-medium text-[1.8rem] text-title'>Web Development Courses</h5>
                    <div className='flex gap-5 items-center mb-[1rem]'>
                        <p className='text-[1.5rem]'>Student</p>
                        <p className='bg-yellow-100 text-[1rem] px-[0.7rem]  py-[0.4rem] text-white'>Jan 2024 - Dec 2024</p>
                    </div>
